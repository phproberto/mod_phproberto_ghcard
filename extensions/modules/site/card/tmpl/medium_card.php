...
<div class="github-card user-card">
	<div class="header User">
		<a class="github-link" alt="<?php echo JText::_('MOD_GITHUB_CARD_LABEL_VIEW_IN_GITHUB'); ?>" href="<?php echo $profile->html_url; ?>">Github</a>
	</div>
	...
	<div class="content">
		...
		<ul class="status">
			<li><a href="<?php echo $profile->html_url; ?>?tab=repositories"><strong><?php echo $profile->public_repos; ?></strong><?php echo JText::_('MOD_GITHUB_CARD_LABEL_REPOSITORIES'); ?></a></li>
			<li><a href="<?php echo $profile->html_url; ?>/followers"><strong><?php echo $profile->followers; ?></strong><?php echo JText::_('MOD_GITHUB_CARD_LABEL_FOLLOWERS'); ?></a></li>
		</ul>
	</div>
	<div class="footer">
