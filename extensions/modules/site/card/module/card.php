 ...
 * @since  0.0.1
 */
final class GithubModuleCard extends PhprobertoModule
{
	/**
	...
	protected function getGithubProfile()
	{
		...
		if (!$member)
		{
			$this->setError(JText::_('MOD_GITHUB_CARD_ERROR_MISSING_PROFILE'));
		...
		{
			$this->setError(JText::sprintf('MOD_GITHUB_CARD_ERROR_GITHUB_CONNECTION', $e->getMessage()));
	 ...
	 * @return  JTable
	 */
	protected function getTable($name = 'Card')
	{
		return JTable::getInstance($name, 'GithubTable', array());
	}
}
