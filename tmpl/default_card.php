...
<div class="github-card user-card">
	...
	<ul class="status">
		<li><a href="<?php echo $profile->html_url; ?>?tab=repositories" target="_top"><strong><?php echo $profile->public_repos; ?></strong><?php echo JText::_('MOD_PHPROBERTO_GHCARD_LABEL_REPOSITORIES'); ?></a></li>
		<li><a href="<?php echo $profile->html_url; ?>/followers" target="_top"><strong><?php echo $profile->followers; ?></strong><?php echo JText::_('MOD_PHPROBERTO_GHCARD_LABEL_FOLLOWERS'); ?></a></li>
	</ul>
	<div class="footer">
